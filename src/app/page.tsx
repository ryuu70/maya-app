  ...
  return (
    <div className="text-center px-2 py-4">
      ...
      {session?.user?.birthday && session.user.name ? (
        // ログイン済みユーザー向けコンテンツ
        <>
          <div className="p-4 sm:p-6 bg-white rounded-lg max-w-md mx-auto mt-4">
        ...
        <div className="p-4 sm:p-6 bg-white rounded-lg max-w-md mx-auto mt-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 sm:p-8 rounded-lg mb-8">
              <h3 className="text-2xl font-bold mb-4">今すぐ始めよう</h3>
              <p className="text-lg mb-6">
                アカウントを作成して、あなたのマヤ暦占いを体験してください。
              </p>
              <div className="space-x-0 space-y-2 sm:space-x-4 sm:space-y-0 flex flex-col sm:flex-row justify-center items-center">
                <a
                  href="/register"
